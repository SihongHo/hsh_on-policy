#!/bin/sh
env="MPE"
scenario="simple_speaker_listener"  # simple_speaker_listener # simple_reference
# simple_speaker_listener do not use shared policy
num_landmarks=3
num_agents=3
algo="rmappo"
# exp="check"
exp="simple_speaker_listener_robust_pretrain"
seed_max=1
